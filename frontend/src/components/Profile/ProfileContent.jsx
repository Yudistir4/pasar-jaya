          ...
          <div className="w-full px-5">
            <form onSubmit={handleSubmit} aria-required={true}>
              ...
              <div className="w-full 800px:flex block pb-3">
                ...
                <div className=" w-[100%] 800px:w-[50%]">
                  <label className="block pb-2">Masukan Kata Sandi</label>
                  <input
                    type="password"
                    className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
                    required
      ...
      <div className="w-full">
        ...
        >
          <div className=" w-[100%] 800px:w-[50%] mt-5">
            <label className="block pb-2">Masukan kata sandi saat ini</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            <label className="block pb-2">Masukan kata sandi baru</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
          ...
          <div className=" w-[100%] 800px:w-[50%] mt-2">
            <label className="block pb-2">Konfirmasi kata sandi</label>
            <input
              type="password"
              className={`${styles.input} !w-[95%] mb-4 800px:mb-0`}
              required
  ...
  return (
    <div className="w-full px-5">
            ...
            <div className="w-full">
              <form aria-required onSubmit={handleSubmit} className="w-full">
                <div className="w-full block p-4">
                  ...
                  <div className="w-full pb-2">
                    <label className="block pb-2">Tipe Alamat</label>
                    <select
                      name=""
                      id=""
                      value={addressType}
      ...
      <div className="flex w-full items-center justify-between">
        ...
        >
          <span className="text-[#fff]">Tambahkan alamat</span>
        </div>
      </div>
      <br />
      {user &&
      ...
      {user && user.addresses.length === 0 && (
        <h5 className="text-center pt-8 text-[18px]">
          Kamu belum menyimpan alamat rumahmu !
        </h5>
      )}
    </div>
  );
