...
export const brandingData = [
  ...
  {
    id: 2,
    title: 'Penawaran seru setiap harinya',
    Description: 'Hemat hingga 25%',
    icon: (
      <svg
        width="32"
        height="34"
  ...
  },
  {
    ...
    Description: 'Harga termurah dari pedagang',
    icon: (
      <svg
        width="32"
        height="35"
  ...
  {
    id: 5,
    title: 'Pembayaran yang aman',
    Description: '100% Keamanannya',
    icon: (
      <svg
        width="32"
        height="38"
